...
{
    public class CampanhaCalculadaVendeuGanhouGrupoItemImportacaoMap : EntityTypeConfiguration<CampanhaCalculadaVendeuGanhouGrupoItemImportacao>
    {
        public CampanhaCalculadaVendeuGanhouGrupoItemImportacaoMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("CampanhaCalculadaVendeuGanhouGrupoItemImportacao");

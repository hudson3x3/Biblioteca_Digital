...
{
    public class CampanhaCalculadaMetaResultadoGrupoItemImportacaoMap : EntityTypeConfiguration<CampanhaCalculadaMetaResultadoGrupoItemImportacao>
    {
        public CampanhaCalculadaMetaResultadoGrupoItemImportacaoMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("CampanhaCalculadaMetaResultadoGrupoItemImportacao");
            this.Property(t => t.Login).HasColumnName("Login");
            this.Property(t => t.Meta).HasColumnName("Meta");
            this.Property(t => t.Efetivo).HasColumnName("Efetivo");
            this.Property(t => t.Atingimento).HasColumnName("Atingimento");

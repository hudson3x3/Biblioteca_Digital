...
{
    public class CampanhaCalculadaMetaResultadoRankingImportacaoMap : EntityTypeConfiguration<CampanhaCalculadaMetaResultadoRankingImportacao>
    {
        public CampanhaCalculadaMetaResultadoRankingImportacaoMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("CampanhaCalculadaMetaResultadoRankingImportacao");

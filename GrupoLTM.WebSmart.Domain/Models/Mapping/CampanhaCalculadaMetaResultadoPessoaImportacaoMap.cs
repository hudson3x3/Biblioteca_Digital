...
{
    public class CampanhaCalculadaMetaResultadoPessoaImportacaoMap : EntityTypeConfiguration<CampanhaCalculadaMetaResultadoPessoaImportacao>
    {
        public CampanhaCalculadaMetaResultadoPessoaImportacaoMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("CampanhaCalculadaMetaResultadoPessoaImportacao");

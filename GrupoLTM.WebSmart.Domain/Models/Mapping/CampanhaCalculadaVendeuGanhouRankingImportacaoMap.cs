...
{
    public class CampanhaCalculadaVendeuGanhouRankingImportacaoMap : EntityTypeConfiguration<CampanhaCalculadaVendeuGanhouRankingImportacao>
    {
        public CampanhaCalculadaVendeuGanhouRankingImportacaoMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("CampanhaCalculadaVendeuGanhouRankingImportacao");
